export class T4DActor extends Actor {
  prepareData() {
    ...
    system.attributes.appearance.desc = this.constructor.HumanAppTable[appIndex] || "Unknown";
    ...
    system.attributesAI.secondary.LIKE.desc = this.constructor.LikeTable[likeIndex] || "Unknown";
    ...
    for (let [stat, field] of Object.entries(statToAPT)) {
      ...
      system.attributes.primary[field] = this.constructor.ApTable[val - 1] || "1";
    }
